...
def parse_args():
    ...
    parser.add_argument('--data_path', default=r'./data', type=str, help='Path to input data')
    parser.add_argument('--batch_size', default=4, type=int, help='Batch size')
    parser.add_argument('--epoch', default=150, type=int, help='Training epoch')
    parser.add_argument('--save_dir', default='./checkpoint', type=str, help='Path to save checkpoint')
...
def train(args):
    ...
    model = LSTM(17*2, 8, 2, len(dataset.category_2_idx)).to(device)
